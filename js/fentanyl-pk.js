...
const FentanylModels = {
    scottStanski: {
        ...
        reference: 'Scott JC, Stanski DR. J Pharmacol Exp Ther 1987;240:159-66 (PMID 3100765). Parameter values as tabulated in Choi BM. Korean J Anesthesiol 2016;69:211-8 (PMC4891531), Table 3.',
        isHybrid: false,
        note: 'The PK and the ke0 were estimated simultaneously from the same data, making this the only model here whose PK/PD comes from a single study. Ce peaks 3.7 min after a bolus at 16.5% of the initial plasma concentration, reproducing the published 3.6 min and 17%. Derived in adult male patients against the EEG spectral edge; carries no weight covariate.',
        weightScaled: false,
    ...
    shafer: {
        ...
        reference: 'Shafer SL et al. Anesthesiology 1990;73:1091-102 (PMID 2248388), with the ke0 borrowed from Scott & Stanski 1987',
        isHybrid: true,
        note: 'A plasma PK model measured under computer-controlled infusion, with no ke0 of its own. Because it borrows the Scott/Stanski ke0 it is not a PK/PD model validated in a single study, and the bolus Ce peak shifts to 3.2 min. Shibutani et al (Anesthesiology 2004;101:603-13, PMID 15329584) report that this model systematically overestimates concentration as total body weight rises.',
        weightScaled: false,
    ...
    bae: {
        ...
        reference: 'Bae J et al. Br J Anaesth 2020;125:976-85 (PMID 32861508), with the ke0 borrowed from Scott & Stanski 1987',
        isHybrid: true,
        note: 'A modern population PK model in 95 adults, and the only one of the three with a body-weight covariate. It reports plasma PK only and contains no ke0, so it is a hybrid, and the bolus Ce peak shifts to 4.3 min. The allometric exponents are not printed in the abstract and the full text is not open access, so the conventional values (1 for volumes, 0.75 for clearances) are assumed.',
        weightScaled: true,
        validWeightRange: null,
        color: '#5BA4CF',
        cpColor: '#4A6FA5',
